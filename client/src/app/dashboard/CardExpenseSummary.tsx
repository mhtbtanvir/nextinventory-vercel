...
const CardExpenseSummary = () => {
  ...
  const totalExpenses = expenseCatagories.reduce(
  ...
  return (
    <div
      className="bg-gray-800/10  shadow-md 
    ...
    >
      {isLoading ? (
        ...
        <>
          {/*header*/}
          <div>
            <h2 className="flex items-center justify-around text-lg font-semibold px-7 bg-blue-200 rounded-lg pt-5 pb-2">
              Expense Summary
            </h2>
            <hr />
          </div>
