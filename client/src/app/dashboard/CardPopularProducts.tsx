...
const CardPopularProducts = () => {
  ...
  return (
    ...
    row-span-3 xl:row-span-6  shadow-md rounded-2xl pb-16"
    >
      {isLoading ? (
        <div className="m-5">isLoading</div>
      ) : (
        <>
          <h3 className="justufy-around flex text-lg font-semibold px-7 bg-blue-200 rounded-lg pt-5 pb-2">
            Popular Products
          </h3>
          <hr />
                          ...
                          <Star
                            ...
                            className={
                              index <= product.rating
                                ? "text-yellow-300 fill-yellow-100"
                                : "text-gray-200"
                            }
                            size={16}
                          />
